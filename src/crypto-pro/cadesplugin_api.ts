(
    function () {
            ...
            if (isIE()) {
                ...
                if (name.match(/X509Enrollment/i)) {
                    try {
                        ...
                        var objCertEnrollClassFactory: CertEnrollClassFactoryElement = document.getElementById("webClassFactory") as CertEnrollClassFactoryElement;
                        return objCertEnrollClassFactory.CreateObject(name);
                    }
                    catch (e) {
                        try {
                            var objWebClassFactory: CertEnrollClassFactoryElement = document.getElementById("certEnrollClassFactory") as CertEnrollClassFactoryElement;
                ...
                try {
                    var objWebClassFactory: CertEnrollClassFactoryElement = document.getElementById("webClassFactory") as CertEnrollClassFactoryElement;
                    return objWebClassFactory.CreateObject(name);
                }
                catch (e) {
        ...
        function decimalToHexString(number): string {
            if (number < 0) {
        ...
        function GetMessageFromException(e): string | Error {
            var err: Error | string = e.message;
            if (!err) {
                err = e;
            } else if (e.number) {
        ...
        function getLastError(exception): string | Error | void {
            if (!exception) {
                return
            }
        ...
        var ru_cryptopro_npcades_10_native_bridge = {
            ...
            call: function call(functionName, args, callback): void {
        ...
        function call_ru_cryptopro_npcades_10_native_bridge(functionName, array): string {
            var tmpobj;
            var ex;
        ...
        function firefox_or_safari_nmcades_onload(): void {
            cpcsp_chrome_nmcades.check_chrome_plugin(plugin_loaded, plugin_loaded_error);
        }

        function nmcades_api_onload(): void {
            ...
            window.addEventListener("message", function (event) {
                ...
                if (isFireFox || isSafari) {
                    ...
                    if (!url.match("^moz-extension://[a-zA-Z0-9-]+/nmcades_plugin_api.js$")
                        ...
                        const message: string = "Bad url \"" + url + "\" for load CryptoPro Extension for CAdES Browser plug-in"
                        cpcsp_console_log(cadesplugin.LOG_LEVEL_ERROR, message);
                        plugin_loaded_error(message);
        ...
        function load_npapi_plugin(): void {
        ...
        function plugin_loaded_error(msg): void {
        ...
        function check_load_timeout(): void {
            if (plugin_resolved)
                return;
            // if (isFireFox) {
        ...
        function check_npapi_plugin(): void {
            try {
        ...
        function check_plugin_working(): void {
        ...
        function set_pluginObject(obj): void {
            pluginObject = obj;
        }

        function is_capilite_enabled(): boolean {
