...
(function () {
  ...
  function nmcades_api_onload() {
    ...
    window.addEventListener("message", function (event) {
      ...
      if (isFireFox || isSafari) {
        ...
        if (!url.match("^moz-extension://[a-zA-Z0-9-]+/nmcades_plugin_api.js$") && !url.match("^safari-extension://[a-zA-Z0-9-]+/[a-zA-Z0-9]+/nmcades_plugin_api.js$")) {
  ...
  function plugin_loaded_error(msg) {
    if (typeof msg === 'undefined' || _typeof(msg) === 'object') msg = "Плагин недоступен";
    plugin_resolved = 1;
  ...
  function check_load_timeout() {
    if (plugin_resolved === 1) return; // if (isFireFox) {
