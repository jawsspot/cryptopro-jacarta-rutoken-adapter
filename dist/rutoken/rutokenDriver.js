...
var _RutokenDriver_instances, _RutokenDriver_deepEqual, _RutokenDriver_isObject, _RutokenDriver_encode, _RutokenDriver_utf8_encode, _RutokenDriver_bytesToBase64, _RutokenDriver_handleError;
...
export class RutokenDriver {
    ...
    // public async isActualVersionPlugin():Promise<boolean> {
    //     try {
    //         let _this = this
    ...
    loadPlugin() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                let isRutokenReady;
                yield this._rutoken.ready;
                if (window.chrome || typeof window.InstallTrigger !== 'undefined') {
                    isRutokenReady = yield this._rutoken.isExtensionInstalled();
                }
                else {
                    isRutokenReady = true;
                }
                if (isRutokenReady) {
                    this.isPluginInstalled = yield this._rutoken.isPluginInstalled();
                }
                if (!this.isPluginInstalled)
                    return;
                this._plugin = yield this._rutoken.loadPlugin();
                this.loadErrorCodes();
                yield this.initialize();
                yield this.getLastRtPluginVersion();
                if (this._plugin)
                ...
                throw __classPrivateFieldGet(this, _RutokenDriver_instances, "m", _RutokenDriver_handleError).call(this, 6, this._errors[reason.message] || reason.message, 'loadPlugin');
            }
        });
    }
    reloadDevices() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (reason.method)
                    throw reason;
                console.log(this._errors[reason.message]);
                throw __classPrivateFieldGet(this, _RutokenDriver_instances, "m", _RutokenDriver_handleError).call(this, 3, this._errors[reason.message] || reason.message, 'reloadDevices');
            }
        });
    }
    signCMS(data, certificateId, deviceId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (!(yield this.bindToken(deviceId))) {
                    console.log('return from bindToken if');
                    return;
                }
                CMS = yield this._plugin.sign(deviceId, certificateId, dataToSign, this._plugin.DATA_FORMAT_BASE64, options);
                console.log(CMS);
                // Закрытие сессии
                yield this._plugin.logout(deviceId);
            }
            catch (reason) {
                if (reason.code === 10) {
                ...
                throw __classPrivateFieldGet(this, _RutokenDriver_instances, "m", _RutokenDriver_handleError).call(this, 2, this._errors[reason.message] || reason.message, 'signCMS');
            }
            return CMS;
        });
    }
            ...
            xhr.onreadystatechange = function () {
                return __awaiter(this, void 0, void 0, function* () {
                    if (xhr.readyState == 4 && xhr.status == 200) {
                        _this.pluginVersion = yield this.response.split('Version: v.')[1].split('Release')[0].replace(/\s+/g, '');
                    }
                });
            };
            xhr.send();
    ...
    initialize() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.getAllCertificates();
            for (var [key, value] of this._deviceMap) {
                for (let j = 0; j < value.length; j++) {
                    yield this.getCertificateInfo(key, value[j]);
                }
            }
        });
    }
    getAllDevices() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                this._deviceList = yield this._plugin.enumerateDevices();
                return this._deviceList;
            }
            catch (e) {
                throw __classPrivateFieldGet(this, _RutokenDriver_instances, "m", _RutokenDriver_handleError).call(this, 3, this._errors[e.message] || e.message, 'getAllDevices');
            }
        });
    }
    getAllCertificates() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                for (let i = 0; i < this._deviceList.length; i++) {
                    ...
                    let certificate = yield this._plugin.enumerateCertificates(this._deviceList[i], this._plugin.CERT_CATEGORY_USER);
                    this._deviceMap.set(this._deviceList[i], certificate);
                }
                return this._deviceMap;
            }
            catch (e) {
                throw __classPrivateFieldGet(this, _RutokenDriver_instances, "m", _RutokenDriver_handleError).call(this, 4, this._errors[e.message] || e.message, 'getAllCertificates');
            }
        });
    }
    getCertificateInfo(deviceId, certificateId) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const certificate = yield this._plugin.parseCertificate(deviceId, certificateId);
    ...
    parseCertificate(certificate) {
        return __awaiter(this, void 0, void 0, function* () {
            let inn = this.getValueFromCertificate(certificate.subject, 'INN'), ogrnip = this.getValueFromCertificate(certificate.subject, 'OGRNIP'), ogrn = this.getValueFromCertificate(certificate.subject, 'OGRN'), snils = this.getValueFromCertificate(certificate.subject, 'SNILS'), surname = this.getValueFromCertificate(certificate.subject, 'surname'), nameAndPatronymic = this.getValueFromCertificate(certificate.subject, 'givenName'), issuerCN = this.getValueFromCertificate(certificate.issuer, 'commonName'), ownerCN = this.getValueFromCertificate(certificate.subject, 'commonName'), innLe = this.getValueFromCertificate(certificate.subject, 'INNLE') || inn, subjectString = '', issuerString = '';
            if (innLe.length > 0) {
            ...
            let now = new Date();
            let certPem = yield this._plugin.getCertificate(this._selectedCertificate.deviceId, this._selectedCertificate.certificateId);
    ...
    bindToken(deviceId) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                let isLoggedIn = yield this._plugin.getDeviceInfo(deviceId, this._plugin.TOKEN_INFO_IS_LOGGED_IN);
                if (isLoggedIn)
                    return true;
                yield this._plugin.login(deviceId, prompt("Введите pin"));
                return true;
            }
            catch (e) {
                throw __classPrivateFieldGet(this, _RutokenDriver_instances, "m", _RutokenDriver_handleError).call(this, 2, (_a = this._errors[e.message]) !== null && _a !== void 0 ? _a : e, 'bindToken');
            }
        });
    }
    loadErrorCodes() {
...
_RutokenDriver_instances = new WeakSet(), _RutokenDriver_deepEqual = function _RutokenDriver_deepEqual(object1, object2) {
