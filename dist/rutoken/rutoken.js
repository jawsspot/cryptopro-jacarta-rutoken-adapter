...
var rutoken = function (my) {
  ...
  function loadPlugin() {
    ...
    obj.style.setProperty("max-height", "0px", "important"); // onload callback must be set before type attribute in IE earlier than 11.

    obj.innerHTML = "<param name='onload' value='rutokenLoaded'/>"; // Just after setting type attribute before function returns promise
  ...
  return my;
}(rutoken || {}); // if (typeof module !== 'undefined') {
//     module.exports = rutoken;
// }


exports.rutoken = rutoken;